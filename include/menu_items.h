...
const menuEntryType MenuItems[MENU_ITEMCOUNT] PROGMEM = { 
  ...
  {"Pot 1 CC", m_pot_assign, &MenuValues[12], NULL, -1, 127},
  {"Pot 2 CC", m_pot_assign, &MenuValues[13], NULL, -1, 127},
  {"Pot 3 CC", m_pot_assign, &MenuValues[14], NULL, -1, 127},
  {"Pot 4 CC", m_pot_assign, &MenuValues[15], NULL, -1, 127},
  {"Pot CC", m_pot_assign, NULL, NULL, -1, -1},
  {"Btn 1 CC/Prg", m_btn_assign, &MenuValues[17], NULL, -1, 127},
  {"Btn 2 CC/Prg", m_btn_assign, &MenuValues[18], NULL, -1, 127},
  {"Btn 3 CC/Prg", m_btn_assign, &MenuValues[19], NULL, -1, 127},
  {"Btn 4 CC/Prg", m_btn_assign, &MenuValues[20], NULL, -1, 127},
  {"Btn 5 CC/Prg", m_btn_assign, &MenuValues[21], NULL, -1, 127},
  {"Btn 6 CC/Prg", m_btn_assign, &MenuValues[22], NULL, -1, 127},
  {"Btn 7 CC/Prg", m_btn_assign, &MenuValues[23], NULL, -1, 127},
  {"Btn 8 CC/Prg", m_btn_assign, &MenuValues[24], NULL, -1, 127},
  {"Btn 9 CC/Prg", m_btn_assign, &MenuValues[25], NULL, -1, 127},
  {"Btn 10 CC/Prg", m_btn_assign, &MenuValues[26], NULL, -1, 127},
  {"Btn 11 CC/Prg", m_btn_assign, &MenuValues[27], NULL, -1, 127},
  {"Btn 12 CC/Prg", m_btn_assign, &MenuValues[28], NULL, -1, 127},
  {"Btn 13 CC/Prg", m_btn_assign, &MenuValues[29], NULL, -1, 127},
  {"Btn 14 CC/Prg", m_btn_assign, &MenuValues[30], NULL, -1, 127},
  {"Btn 15 CC/Prg", m_btn_assign, &MenuValues[31], NULL, -1, 127},
  {"Btn 16 CC/Prg", m_btn_assign, &MenuValues[32], NULL, -1, 127},
  {"Btn CC", m_btn_assign, NULL, NULL, -1, -1},
  {"Btn 1 Mode", m_btn_mode, &MenuValues[34], &setBtnMode, 0, 3},
  {"Btn 2 Mode", m_btn_mode, &MenuValues[35], &setBtnMode, 0, 3},
  {"Btn 3 Mode", m_btn_mode, &MenuValues[36], &setBtnMode, 0, 3},
  {"Btn 4 Mode", m_btn_mode, &MenuValues[37], &setBtnMode, 0, 3},
  {"Btn 5 Mode", m_btn_mode, &MenuValues[38], &setBtnMode, 0, 3},
  {"Btn 6 Mode", m_btn_mode, &MenuValues[39], &setBtnMode, 0, 3},
  {"Btn 7 Mode", m_btn_mode, &MenuValues[40], &setBtnMode, 0, 3},
  {"Btn 8 Mode", m_btn_mode, &MenuValues[41], &setBtnMode, 0, 3},
  {"Btn 9 Mode", m_btn_mode, &MenuValues[42], &setBtnMode, 0, 3},
  {"Btn 10 Mode", m_btn_mode, &MenuValues[43], &setBtnMode, 0, 3},
  {"Btn 11 Mode", m_btn_mode, &MenuValues[44], &setBtnMode, 0, 3},
  {"Btn 12 Mode", m_btn_mode, &MenuValues[45], &setBtnMode, 0, 3},
  {"Btn 13 Mode", m_btn_mode, &MenuValues[46], &setBtnMode, 0, 3},
  {"Btn 14 Mode", m_btn_mode, &MenuValues[47], &setBtnMode, 0, 3},
  {"Btn 15 Mode", m_btn_mode, &MenuValues[48], &setBtnMode, 0, 3},
  {"Btn 16 Mode", m_btn_mode, &MenuValues[49], &setBtnMode, 0, 3},
  {"Btn Mode", m_btn_mode, NULL, NULL, -1, -1},
  {"Kbd Driver", m_kbd_driver, &MenuValues[51], &setKbdDriver, 0, 4},
  {"Velocity Min", m_kbd_driver, &MenuValues[52], &setDynSlope, 1, 30},
  {"Velocity MaxAdj", m_kbd_driver, &MenuValues[53], NULL, 0, 20},
  {"Velocity Slope", m_kbd_driver, &MenuValues[54], &setDynSlope, 1, 40},
  {"Upper Base", m_kbd_driver, &MenuValues[55], NULL, 12, 60},
  {"Lower Base", m_kbd_driver, &MenuValues[56], NULL, 12, 60},
  {"Pedal Base", m_kbd_driver, &MenuValues[57], NULL, 12, 60},
  {"Keyboard", m_kbd_driver, &MenuValues[58], NULL, -1, -1},
};
// Items with Action != NULL will need the editAction() to display lower LCD row value!
#define MENU_POT_CC 12
#define MENU_BTN_CC 17
#define MENU_BTN_MODE 34
#define MENU_KBD_DRIVER 51
#define MENU_MIN_DYN 52
#define MENU_MAX_DYNADJ 53
#define MENU_DYNSLOPE 54
#define MENU_BASE_UPR 55
#define MENU_BASE_LWR 56
#define MENU_BASE_PED 57
